...
| URL | Source class |
|-----|----------------|
| https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.s3.md | Public docs only |
| https://docs.n8n.io/integrations/builtin/credentials/s3.md | Public docs only |

## Wire format

- **Type string:** `n8n-nodes-base.s3`
- **Aliases:** (none)
- **Inputs:** `main` × 1
- **Outputs:** `main` × 1
...
- **Executor file:** `src/lib/engine/executors/s3.ts`
