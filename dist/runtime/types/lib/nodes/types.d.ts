 ...
 */
export type NodePropertyType = "string" | "number" | "boolean" | "options" | "multiOptions" | "collection" | "fixedCollection" | "dateTime" | "json" | "resourceLocator" | "resourceMapper" | "workflowSelect" | "notice" | "color"
/** Carried on the node but never rendered — see ParameterField's `hidden` case. */
 | "hidden" | "credentials" | "assignmentCollection";
...
export type NodeGroup = "trigger" | "input" | "output" | "transform" | "organization" | "integration" | "communication" | "storage" | "marketing" | "data" | "app" | "ai";
/**
 ...
 */
export type NodeCategory = "Triggers" | "Actions" | "Flow" | "Transform" | "Helpers" | "Canvas" | "AI" | "AI Tool" | "Communication" | "Data & Storage" | "Database" | "Development" | "Productivity" | "Files" | "Marketing" | "Sales" | "CRM" | "Finance & Accounting" | "Payments" | "Analytics" | "App" | "Core" | "Utility" | "Miscellaneous";
...
export declare function resolveOutputs(description: INodeTypeDescription, parameters: Record<string, unknown>): string[];
/** Dedicated AI-agent tool sub-node (cluster tool), not a regular main-chain node. */
export declare function isAiToolSubnode(description: INodeTypeDescription): boolean;
export declare function resolveInputs(description: INodeTypeDescription, parameters: Record<string, unknown>): string[];
