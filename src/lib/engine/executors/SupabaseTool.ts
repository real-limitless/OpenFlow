...
export const supabaseToolExecutor: NodeExecutor = async (ctx) => {
    ...
    try {
      ...
      switch (operation) {
        ...
        case "delete": {
          ...
          result = await supabaseApi("DELETE", tableId, credential, qParams, undefined, schema);
          break;
        }
      ...
      const resultArray = (() => {
        ...
        if (operation === "delete" && Array.isArray(result)) {
