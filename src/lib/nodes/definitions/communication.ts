...
export const getResponse: INodeTypeDescription = {
  ...
  group: ["communication"],
  version: 1,
  description: "Create, update, get, delete, and list contacts via GetResponse API",
  defaults: { name: "GetResponse" },
  inputs: ["main"],
  outputs: ["main"],
  credentials: [
    { name: "getResponseApi", required: false },
    { name: "getResponseOAuth2Api", required: false },
  ],
  icon: "Mail",
  sources: [GETRESPONSE_DOCS, "https://apidocs.getresponse.com/v3"],
  properties: [
    {
      displayName: "Resource",
      name: "resource",
    ...
    },
    {
      ...
      description: "Target campaign that the contact belongs to",
    },
    {
      displayName: "Contact ID",
      name: "contactId",
      ...
      description: "Contact resource ID from GetResponse; alternative to email lookup",
    },
    {
      displayName: "Name",
      name: "name",
    ...
    },
    {
      ...
      placeholder: '[{"customFieldId": "FIELD_ID", "value": ["val"]}]',
    },
    {
    ...
    },
    {
      ...
      options: [
        {
          displayName: "Sort By Created On",
          name: "sortBy",
          type: "options",
          default: "asc",
          options: [
...
export const egoi: INodeTypeDescription = {
  ...
  group: ["communication"],
  version: 1,
  description: "Manage E-goi contacts via their REST API v3",
  defaults: { name: "E-goi" },
  inputs: ["main"],
  outputs: ["main"],
  credentials: [{ name: "egoiApi", required: true }],
  icon: "Mail",
  sources: [EGOI_DOCS, "https://developers.e-goi.com/api/v3/"],
  properties: [
    {
      displayName: "Resource",
      name: "resource",
    ...
    },
    {
      ...
      required: true,
      displayOptions: { show: { resource: ["contact"] } },
      description: "Target list ID; dynamically loaded from E-goi API",
    },
    {
      displayName: "Email",
      name: "email",
      ...
      required: false,
      displayOptions: {
        show: { resource: ["contact"], operation: ["create", "get", "update"] },
      },
      description: "Contact email address; required for create, get, update",
    },
    {
    ...
    },
    {
      ...
      default: "",
      displayOptions: { show: { resource: ["contact"] } },
      description: "Comma-separated tag IDs to assign to the contact",
    },
    {
      displayName: "Options",
      name: "options",
      ...
      options: [
        ...
        {
          displayName: "Cellphone Indicative",
          name: "cellphoneIndicative",
          type: "string",
          default: "",
          placeholder: "+1",
        },
...
export const egoiTool: INodeTypeDescription = {
  ...
  group: ["input"],
  version: 1,
  description: "Create, read, update, and delete E-goi contacts via their REST API v3 (AI agent tool variant)",
  defaults: { name: "E-goi Tool" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Mail",
  credentials: [{ name: "egoiApi", required: true }],
  usableAsTool: true,
  sources: [EGOI_TOOL_DOCS, "https://developers.e-goi.com/api/v3/"],
  properties: [
    {
      displayName: "Resource",
      name: "resource",
    ...
    },
    {
      ...
      description: "Contact email address; required for create, get, update. Supports $fromAI() for AI agent dynamic population.",
    },
    {
      displayName: "Update Action",
      name: "updateAction",
