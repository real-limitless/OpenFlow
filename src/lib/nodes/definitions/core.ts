...
export const airtableTool: INodeTypeDescription = {
  ...
  displayName: "Airtable (AI Tool)",
  category: "Actions",
  group: ["input"],
  version: 1,
  description: "Interact with Airtable API. Designed for AI agent tool use.",
  defaults: { name: "Airtable Tool" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Airtable",
  credentials: [
  ...
  sources: [
    "https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.airtable.md",
  ],
  properties: [
    {
      displayName: "Authentication",
      ...
      noDataExpression: true,
      options: [
        { name: "Personal Access Token", value: "airtableTokenApi" },
