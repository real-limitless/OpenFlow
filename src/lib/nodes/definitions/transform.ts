...
export const splitOut: INodeTypeDescription = {
  name: "openflow-node-base.splitOut",
...
export const aggregate: INodeTypeDescription = {
  name: "openflow-node-base.aggregate",
...
export const summarize: INodeTypeDescription = {
  name: "openflow-node-base.summarize",
...
export const filter: INodeTypeDescription = {
  name: "openflow-node-base.filter",
  displayName: "Filter",
  category: "Transform",
  group: ["transform"],
  version: 1,
...
export const executeWorkflow: INodeTypeDescription = {
  name: "openflow-node-base.executeWorkflow",
...
export const removeDuplicates: INodeTypeDescription = {
  name: "openflow-node-base.removeDuplicates",
...
export const itemLists: INodeTypeDescription = {
  name: "openflow-node-base.itemLists",
...
export const toolWikipedia: INodeTypeDescription = {
  name: "openflow-node-langchain.toolWikipedia",
...
export const openThesaurus: INodeTypeDescription = {
  name: "openflow-node-base.openThesaurus",
...
export const hubGPT: INodeTypeDescription = {
  name: "openflow-node-base.hubGPT",
  displayName: "HubGPT",
  category: "AI",
  group: ["transform"],
  version: 1,
  description: "AI-powered text generation using GPT-3.5/OpenAI.",
  defaults: { name: "HubGPT" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Bot",
  // TODO: No parameter schema recoverable from public docs. Scraped workflows
  // use an empty parameters object. Credential type is inferred as openAiApi.
  properties: [
    {
      displayName: "Model",
      name: "model",
...
export const mailcheck: INodeTypeDescription = {
  name: "openflow-node-base.mailcheck",
  displayName: "Mailcheck",
  category: "Utility",
  group: ["transform"],
  version: 1,
  description: "Validates email addresses via the Mailcheck.co API.",
  defaults: { name: "Mailcheck" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "MailCheck",
...
export const postHogTool: INodeTypeDescription = {
  name: "openflow-node-base.postHogTool",
  displayName: "PostHog Tool",
  category: "Analytics",
  group: ["transform"],
  version: 1,
  description: "Sends analytics events, aliases, and identity data to PostHog.",
  defaults: { name: "PostHog Tool" },
  inputs: ["main"],
  outputs: ["main"],
  ...
  properties: [
    ...
    },
    {
      ...
      options: [
        { name: "Create an event", value: "Create an event" },
      ],
    },
    {
      displayName: "Operation",
      name: "operation",
      type: "options",
      default: "Create an alias",
      noDataExpression: true,
      displayOptions: { show: { resource: ["Alias"] } },
      options: [
        { name: "Create an alias", value: "Create an alias" },
      ],
    },
    {
      displayName: "Operation",
    ...
    },
    {
      ...
      name: "operation",
      type: "options",
      default: "Track a page",
      noDataExpression: true,
      displayOptions: { show: { resource: ["Track"] } },
      options: [
        { name: "Track a page view", value: "Track a page" },
        { name: "Track a screen view", value: "Track a screen" },
      ],
    },
    {
      ...
      default: "",
      required: true,
      displayOptions: { show: { resource: ["Event"], operation: ["Create an event"] } },
      description: "Event type string sent to PostHog",
    },
    {
      ...
      default: "",
      required: true,
      displayOptions: { show: { resource: ["Event", "Alias", "Identity", "Track"] } },
      description: "User or device identifier",
    },
    {
      ...
      type: "json",
      default: "",
      displayOptions: { show: { resource: ["Event", "Track"] } },
    ...
    },
    {
      ...
      type: "string",
      default: "",
      displayOptions: { show: { resource: ["Event", "Identity", "Track"] } },
      description: "Override for when the event occurred (ISO 8601)",
    },
    {
      displayName: "Alias",
      name: "alias",
      ...
      default: "",
      required: true,
      displayOptions: { show: { resource: ["Alias"], operation: ["Create an alias"] } },
      description: "New alias to merge into the existing distinct ID",
    },
    {
      ...
      description: "Key-value object of person properties to upsert",
    },
    {
      ...
      type: "string",
      default: "",
      displayOptions: { show: { resource: ["Track"], operation: ["Track a page"] } },
      description: "Current URL or page identifier",
    },
    {
      ...
      type: "string",
      default: "",
      displayOptions: { show: { resource: ["Track"], operation: ["Track a screen"] } },
      description: "Name of the screen viewed",
    },
  ],
};

export const mailcheckTool: INodeTypeDescription = {
  name: "openflow-node-base.mailcheckTool",
  displayName: "Mailcheck Tool",
  category: "Utility",
  group: ["transform"],
  version: 1,
  description: "Validates email addresses via the Mailcheck.co API (Tool).",
  defaults: { name: "Mailcheck Tool" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "MailCheck",
  credentials: [{ name: "mailcheckApi", required: true }],
...
export const clockify: INodeTypeDescription = {
  name: "openflow-node-base.clockify",
...
export const apiTemplateIo: INodeTypeDescription = {
  name: "openflow-node-base.apiTemplateIo",
...
export const dateTime: INodeTypeDescription = {
  name: "openflow-node-base.dateTime",
...
export const moveBinaryData: INodeTypeDescription = {
  name: "openflow-node-base.moveBinaryData",
...
export const convertToFile: INodeTypeDescription = {
  name: "openflow-node-base.convertToFile",
...
export const extractFromFile: INodeTypeDescription = {
  name: "openflow-node-base.extractFromFile",
...
export const dataTable: INodeTypeDescription = {
  name: "openflow-node-base.dataTable",
...
export const dataTableTool: INodeTypeDescription = {
  name: "openflow-node-base.dataTableTool",
...
export const compareDatasets: INodeTypeDescription = {
  name: "openflow-node-base.compareDatasets",
...
export const renameKeys: INodeTypeDescription = {
  name: "openflow-node-base.renameKeys",
...
export const plivoTool: INodeTypeDescription = {
  name: "openflow-node-base.plivoTool",
  displayName: "Plivo Tool",
  category: "Communication",
  group: ["transform"],
  version: 1,
  description: "Send SMS, MMS, and make voice calls via Plivo (AI Tool).",
  defaults: { name: "Plivo Tool" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Phone",
  ...
  properties: [
    ...
    },
    {
      ...
      description: "Plivo phone number (sender ID) or Caller ID in E.164 format",
    },
    {
      displayName: "To",
      name: "to",
    ...
    },
    {
      ...
      default: "",
      required: false,
      displayOptions: { show: { resource: ["sms", "mms"] } },
    ...
    },
    {
      ...
      description: "Comma-separated media attachment URLs",
    },
    {
      ...
      description: "URL returning Plivo XML for call handling",
    },
    {
...
export const markdown: INodeTypeDescription = {
  name: "openflow-node-base.markdown",
...
export const compression: INodeTypeDescription = {
  name: "openflow-node-base.compression",
...
export const htmlExtract: INodeTypeDescription = {
  name: "openflow-node-base.htmlExtract",
...
export const aiTransform: INodeTypeDescription = {
  name: "openflow-node-base.aiTransform",
...
export const editImage: INodeTypeDescription = {
  name: "openflow-node-base.editImage",
...
export const webflow: INodeTypeDescription = {
  name: "openflow-node-base.webflow",
  displayName: "Webflow",
  category: "Transform",
  group: ["transform"],
  version: [1, 2],
...
export const airtable: INodeTypeDescription = {
  name: "openflow-node-base.airtable",
...
export const notion: INodeTypeDescription = {
  name: "openflow-node-base.notion",
  displayName: "Notion",
  category: "Productivity",
  group: ["transform"],
  version: [1, 2, 2.1, 2.2],
...
export const googleSheets: INodeTypeDescription = {
  name: "openflow-node-base.googleSheets",
...
export const googleDocs: INodeTypeDescription = {
  name: "openflow-node-base.googleDocs",
...
export const discord: INodeTypeDescription = {
  name: "openflow-node-base.discord",
  displayName: "Discord",
  category: "Transform",
  group: ["output"],
  version: [1, 2],
...
export const googleCalendar: INodeTypeDescription = {
  name: "openflow-node-base.googleCalendar",
...
export const youTube: INodeTypeDescription = {
  name: "openflow-node-base.youTube",
  displayName: "YouTube",
  category: "Marketing",
  group: ["output"],
  version: 1,
...
export const spreadsheetFile: INodeTypeDescription = {
  name: "openflow-node-base.spreadsheetFile",
...
export const iCalendar: INodeTypeDescription = {
  name: "openflow-node-base.iCalendar",
...
export const googleTranslate: INodeTypeDescription = {
  name: "openflow-node-base.googleTranslate",
...
export const googleAds: INodeTypeDescription = {
  name: "openflow-node-base.googleAds",
...
export const googleGemini: INodeTypeDescription = {
  name: "openflow-node-langchain.googleGemini",
...
export const openAiApp: INodeTypeDescription = {
  name: "openflow-node-base.openAi",
  displayName: "OpenAI",
  category: "Actions",
  group: ["transform"],
  version: 1,
...
export const airtableTool: INodeTypeDescription = {
  name: "openflow-node-base.airtableTool",
  displayName: "Airtable",
  category: "AI Tool",
  group: ["transform"],
  version: [1],
...
export const googlePerspective: INodeTypeDescription = {
  name: "openflow-node-base.googlePerspective",
...
export const airtop: INodeTypeDescription = {
  name: "openflow-node-base.airtop",
  displayName: "Airtop",
  category: "Transform",
  group: ["transform"],
  version: [1, 1.1],
...
export const sentimentAnalysis: INodeTypeDescription = {
  name: "openflow-node-langchain.sentimentAnalysis",
...
export const postgres: INodeTypeDescription = {
  name: "openflow-node-base.postgres",
  displayName: "Postgres",
  category: "Data & Storage",
  group: ["transform"],
  version: [1, 2, 2.1, 2.2, 2.3, 2.4, 2.5, 2.6],
  description: "Execute SQL queries, insert, update, upsert, select, or delete PostgreSQL data.",
  ...
  properties: [
    ...
    },
    {
      ...
      description: "Column used to match rows for update/upsert",
    },
    {
      ...
      type: "string",
      default: "*",
      displayOptions: { show: { operation: ["insert", "update", "upsert", "select"] } },
    ...
    },
    {
      ...
      default: {},
      typeOptions: { multipleValues: true },
      displayOptions: { show: { operation: ["select", "update", "deleteTable"] } },
      options: [
        {
          name: "values",
          displayName: "Condition",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          type: "string",
          default: "",
          description: "Comma-separated values for $1, $2… placeholders",
        },
        {
...
export const postgresTool: INodeTypeDescription = {
  name: "openflow-node-base.postgresTool",
...
export const textSplitterCharacterTextSplitter: INodeTypeDescription = {
  name: "openflow-node-langchain.textSplitterCharacterTextSplitter",
...
export const textSplitterTokenSplitter: INodeTypeDescription = {
  name: "openflow-node-langchain.textSplitterTokenSplitter",
...
export const spotify: INodeTypeDescription = {
  name: "openflow-node-base.spotify",
  displayName: "Spotify",
  category: "Input",
  group: ["input"],
  version: 1,
...
export const mySqlTool: INodeTypeDescription = {
  name: "openflow-node-base.mySqlTool",
...
export const supabaseTool: INodeTypeDescription = {
  name: "openflow-node-base.supabaseTool",
...
export const clockifyTool: INodeTypeDescription = {
  name: "openflow-node-base.clockifyTool",
...
export const iCal: INodeTypeDescription = {
  name: "openflow-node-base.iCal",
  displayName: "iCalendar",
  category: "Transform",
  group: ["transform"],
  version: 1,
  description: "Generate an .ics file from event parameters",
  defaults: { name: "iCalendar" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Calendar",
  sources: ["https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.converttofile/"],
  properties: [
    {
      displayName: "Operation",
      name: "operation",
      ...
      default: "createEventFile",
      noDataExpression: true,
      options: [{ name: "Create Event File", value: "createEventFile" }],
    },
    { displayName: "Title", name: "title", type: "string", default: "", description: "Event title" },
    { displayName: "Start", name: "start", type: "dateTime", default: "", required: true, description: "Event start (UTC or workflow timezone)" },
    { displayName: "End", name: "end", type: "dateTime", default: "", required: true, description: "Event end; if unset defaults to start" },
    { displayName: "All Day", name: "allDay", type: "boolean", default: false, description: "When true, dates become DATE values (no time)" },
    { displayName: "Binary Property Name", name: "binaryPropertyName", type: "string", default: "data", required: true, description: "Output binary field name for the .ics file" },
    {
      displayName: "Additional Fields",
      name: "additionalFields",
      type: "collection",
      default: {},
      options: [
        { displayName: "File Name", name: "fileName", type: "string", default: "event.ics", description: "Override the generated file name" },
        { displayName: "Calendar Name", name: "calName", type: "string", default: "", description: "Calendar name (X-WR-CALNAME)" },
        { displayName: "Description", name: "description", type: "string", default: "", description: "Event description body" },
        { displayName: "Location", name: "location", type: "string", default: "", description: "Free-text venue string" },
        { displayName: "Recurrence Rule", name: "recurrenceRule", type: "string", default: "", description: "iCalendar RRULE string" },
        { displayName: "Status", name: "status", type: "options", default: "CONFIRMED", options: [
          { name: "Confirmed", value: "CONFIRMED" },
          { name: "Cancelled", value: "CANCELLED" },
          { name: "Tentative", value: "TENTATIVE" },
        ]},
        { displayName: "UID", name: "uid", type: "string", default: "", description: "Globally unique identifier (auto-generated if empty)" },
        { displayName: "URL", name: "url", type: "string", default: "", description: "URL associated with the event" },
        { displayName: "Sequence", name: "sequence", type: "number", default: 0, description: "Revision sequence number" },
        { displayName: "Busy Status", name: "busyStatus", type: "options", default: "", options: [
          { name: "Busy", value: "BUSY" },
          { name: "Tentative", value: "TENTATIVE" },
        ], description: "Maps to X-MICROSOFT-CDO-BUSYSTATUS" },
      ],
    },
  ],
};

export const plivo: INodeTypeDescription = {
  name: "openflow-node-base.plivo",
  displayName: "Plivo",
  category: "Communication",
  group: ["transform"],
  version: 1,
  description: "Send SMS, MMS, and make voice calls via the Plivo API",
  defaults: { name: "Plivo" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Phone",
  credentials: [{ name: "plivoApi", required: true }],
  sources: [
    "https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.plivo/",
  ...
  properties: [
    ...
    },
    {
      ...
      displayOptions: { show: { resource: ["sms", "mms"] } },
      placeholder: "+14156667777",
      description: "Plivo phone number (sender ID)",
    },
    {
      displayName: "To",
      name: "to",
    ...
    },
    {
      ...
      displayOptions: { show: { resource: ["call"] } },
      placeholder: "+14156667777",
      description: "Caller ID in E.164 format",
    },
    {
      displayName: "To",
      name: "to",
    ...
    },
    {
      ...
      displayOptions: { show: { resource: ["call"] } },
      placeholder: "https://example.com/answer.xml",
      description: "URL returning Plivo XML to execute when call is answered",
    },
    {
      displayName: "Answer Method",
      name: "answer_method",
...
export const rundeck: INodeTypeDescription = {
  name: "openflow-node-base.rundeck",
  displayName: "Rundeck",
  category: "Communication",
  group: ["transform"],
  version: 1,
  description: "Triggers Rundeck job executions and retrieves job metadata",
  defaults: { name: "Rundeck" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Play",
  ...
  properties: [
    ...
    },
    {
      ...
      options: [
        { name: "Execute Job", value: "executeJob" },
        { name: "Get Job Metadata", value: "getJobMetadata" },
      ],
    },
    {
      displayName: "Job ID",
      ...
      required: true,
      displayOptions: {
        show: { resource: ["job"], operation: ["executeJob", "getJobMetadata"] },
      },
      description: "UUID of the Rundeck job to execute or inspect",
    },
    {
      ...
      type: "string",
      default: "",
      displayOptions: { show: { resource: ["job"], operation: ["executeJob"] } },
      description: "Node filter string to limit which nodes the job runs on",
    },
    {
    ...
    },
    {
      ...
      default: "",
      displayOptions: { show: { resource: ["job"], operation: ["executeJob"] } },
      description: "Run the job as a different user (requires runAs permission)",
    },
    {
      displayName: "Run At Time",
      name: "runAtTime",
      type: "string",
      default: "",
      displayOptions: { show: { resource: ["job"], operation: ["executeJob"] } },
      description: "ISO-8601 datetime to schedule future execution",
    },
    {
      displayName: "Options",
      name: "options",
...
const CORE_APP = "https://docs.n8n.io/integrations/builtin/app-nodes/";

export const timescaleDb: INodeTypeDescription = {
  name: "openflow-node-base.timescaleDb",
  displayName: "TimescaleDB",
  category: "Data & Storage",
  group: ["app"],
  version: 1,
  description: "Executes SQL queries, inserts, and updates against a TimescaleDB database",
  defaults: { name: "TimescaleDB" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "Database",
  sources: [`${CORE_APP}n8n-nodes-base.timescaledb/`],
  ...
  properties: [
    {
      ...
      options: [
        ...
        { name: "Insert", value: "insert", action: "Insert rows in database" },
        { name: "Update", value: "update", action: "Update rows in database" },
      ],
    },
    {
      displayName: "Query",
      ...
      displayOptions: { show: { operation: ["executeQuery"] } },
      description:
        "Raw SQL query string. Supports $1, $2, ... positional placeholders.",
      typeOptions: { rows: 4, editor: "code" },
    },
    {
      displayName: "Query Parameters",
      name: "queryParameters",
      ...
      displayOptions: { show: { operation: ["executeQuery"] } },
      description:
        "Comma-separated values bound positionally to $1, $2, ... placeholders",
    },
    {
      displayName: "Table",
      name: "table",
      ...
      required: true,
      displayOptions: { show: { operation: ["insert", "update"] } },
      description: "Target TimescaleDB table name",
    },
    {
      displayName: "Columns",
      name: "columns",
      ...
      default: "",
      displayOptions: { show: { operation: ["insert", "update"] } },
      placeholder: "id:int,name:text",
      description:
        "Comma-separated column list with optional :type suffix. Omitted means all input item keys are used.",
    },
    {
      displayName: "Additional Fields",
      name: "additionalFields",
...
export const xNode: INodeTypeDescription = {
  name: "openflow-node-base.x",
  displayName: "XML (Parse)",
  category: "Transform",
  group: ["transform"],
  version: 1,
  description: "Convert data between JSON and XML.",
  defaults: { name: "XML (Parse)" },
  inputs: ["main"],
  outputs: ["main"],
  icon: "FileCode",
  sources: [`${CORE}n8n-nodes-base.xml/`],
  properties: [
    ...
    },
    {
      ...
      default: "data",
      required: true,
      description: "Name of the property containing the source text to convert.",
    },
    {
      displayName: "Options",
      name: "options",
